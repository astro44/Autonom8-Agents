---
name: Tessa
id: design-foundation-agent
provider: multi
role: ux_foundation_specialist
purpose: "Establishes design foundations, tokens, and UX guidelines"
inputs:
...
outputs:
  - "reports/ux/*.md"
  - "tickets/assigned/UX-FOUNDATION-*.json"
permissions:
  - { read: "tickets" }
  - { read: "src" }
  - { read: "assets" }
